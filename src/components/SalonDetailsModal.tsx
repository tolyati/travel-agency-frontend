...
export default function SalonDetailsModal({ item, onClose }: Props) {
  return (
    <div
    ...
    >
      ...
      >
        ...
        <button
          onClick={onClose}
          className="w-full bg-purple-600 hover:bg-purple-500 text-white py-2 rounded-xl transition"
        >
          Вернуться к выбору салона
        </button>
      </div>
    </div>
  );
